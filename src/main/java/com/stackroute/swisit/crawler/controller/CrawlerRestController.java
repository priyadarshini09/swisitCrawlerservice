...
public class CrawlerRestController {
	...
	public ResponseEntity<Map<String,String>> receiveMessage() throws JsonParseException, JsonMappingException, IOException{
	    ...
	    /*Set<ConstraintViolation<SearcherResult[]>> violations = validator.validate(searcherResult);
	    for(ConstraintViolation<SearcherResult[]> violation : violations){
	    ...
	    //System.out.println(searcherResult[0].getLink());
	    //System.out.println(searcherResult.length);
